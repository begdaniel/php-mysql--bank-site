...
if(is_post_request()) {
  ...
  if($result) {
    shift_page_positions($start_pos, 0, $page['subject_id']);
    $_SESSION['message'] = "Page succesfully deleted.";
  ...
  <div id="content">
    ...
    <a class="back-link" href="<?php echo url_for('/staff/subjects/show.php?=' . h(u($page['subject_id']))); ?>">&laquo; Back to subject </a>
